...
export class MyAssets extends connect(store)(LitElement) {
  ...
  render() {
    return html`<div class="container px-4 py-5 my-5 text-center justify-content-start">
            <h1 class="fw-bold width-auto mb-5">My Assets</h1>
              ...
              <table class="table table-borderless">
                ...
                <tbody>
                  ${this.assets.map(asset => html`<tr>
                    ...
                    <td style="height:70px"><div class="full-height d-flex justify-content-center align-items-center"><div>${asset.balance}</div></div></td>
                    <td style="height:70px"><div class="full-height d-flex justify-content-center align-items-center"><div>${asset.totalAssets}</div></div></td>
                    ...
                    <div class="modal-dialog modal-sm vertical-align-center">
                        ...
                        <div class="modal-body" style="border-radius:12px;border:1px solid #dee6f1;margin:15px;">
                            <div class="mb-3 mt-3 justify-content-start">
                              ...
                              <input type="text" class="form-control" id="destination" placeholder="Enter destination" name="destination" .value=${this.destination} @input=${e => this.destination = e.target.value}>
                            </div>
                        ...
                        <div class="modal-footer border-none">
                            ${!!this.destination && this.destination !== this.walletAddress && BigNumber(this.max).isGreaterThan(BigNumber(this.amount)) && BigNumber(this.amount).isGreaterThan(BigNumber('0')) ? html`<button type="button" class="btn btn-primary full-width" data-bs-dismiss="transfer-modal" @click=${e => this.transfer()}><b>Make Offer</b></button>` : html`<button type="button" class="btn btn-primary full-width" data-bs-dismiss="transfer-modal" disabled><b>Make Offer</b></button>`
      }
...
customElements.define('myassets-panel', MyAssets)